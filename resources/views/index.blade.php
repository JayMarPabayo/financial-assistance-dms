        ...
        <div class="flex h-full w-full text-base">
            <section class="grow px-8">
                <div class="w-full h-96 mb-10">
                    <img src="{{ asset('images/banner.jpg') }}" alt="Banner" class="object-cover object-top w-full h-full">
                </div>
            ...
            <section class="w-[70rem] border-s border-slate-600/50 px-10">
                <img src="{{ asset('images/dswd-logo.png') }}" class="w-24 shadow-md mb-5" alt="DSWD">
                <img src="{{ asset('images/tagoloan-logo.png') }}" class="w-24 shadow-md mb-5" alt="Tagoloan">
                <img src="{{ asset('images/information-logo.png') }}" class="w-24 shadow-md mb-5" alt="Information">
            </section>
        </div>
    </main>
</x-layout>
