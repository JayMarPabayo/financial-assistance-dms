        ...
        <form action="{{ route('services.store') }}" method="post">
            ...
            <section class="flex items-center w-full gap-x-4">
                <div class="w-1/2">
                    ...
                    <input type="text" autocomplete="off" name="name" placeholder="Input service name" value="{{ old('name') }}" class="w-full">
                </div>
            </section>
            ...
            <textarea name="description" placeholder="Description" rows="5" class="w-full">{{ old('description') }}</textarea>
